            ...
            for x in 0..MAP_WIDTH {
                ...
                if *explored {
                    ...
                    if wall {
                        ...
                        con.put_char(x, y, WALL, BackgroundFlag::Set);
                    }
                    else {
                        con.set_default_foreground(color);
                        con.put_char(x, y, FLOOR, BackgroundFlag::Set);
                    }
                }
            }
        }
...
fn main(){
    ...
    message(&mut messages, "Welcome stranger! ", colors::RED);
